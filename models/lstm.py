# Original model presented in: C. Spampinato, S. Palazzo, I. Kavasidis, D. Giordano, N. Souly, M. Shah, Deep Learning
# Human Mind for Automated Visual Classification, CVPR 2017
import torch
